...
export default function PJSayaDetail({ navigation, route }) {
    ...
    const __getTransaction = () => {
        getData('user').then(uu => {
            axios.post(apiURL + 'pj_list_detail', {
                fid_user: uu.id,
    ...
    return (
        ...
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.navigate('PJSayaAdd', header)} style={{
                    borderWidth: 1,
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    ...
                                    color: colors.primary,
                                    fontSize: 12
                                }}>{moment(item.tanggal_detail).format('dddd, DD MMMM YYYY')} ; {item.jam_detail}</Text>
                            </View>
                            ...
                            <TouchableOpacity onPress={() => {
                                Alert.alert(MYAPP, 'Apakah mau hapus ini ?', [
                                    { text: 'TIDAK' },
                                    {
                                        text: 'HAPUS',
                                        onPress: () => {
                                            axios.post(apiURL + 'pj_detail_delete', {
                                                id: item.id
                                            }).then(r => {
                                                showMessage({
